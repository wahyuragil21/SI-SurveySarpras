  ...
  const myChart = (chartType) => {
    ...
    $.ajax({
      ...
      success: data => {
        ...
        switch (chartType) {
          case 'bar':
            chartData.datasets[0].backgroundColor = ['rgb(255, 255, 0)', 'rgba(56, 86, 255, 0.87)', 'rgb(60, 179, 113)']
            chartData.datasets[0].borderColor = ['rgb(255, 255, 0)', 'rgba(56, 86, 255, 0.87)', 'rgb(60, 179, 113)']
            break;
