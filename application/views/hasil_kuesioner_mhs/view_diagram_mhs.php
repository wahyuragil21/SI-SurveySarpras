<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <!-- <ul class="nav nav-pills">
            ...
            <li class="nav-item">
                <a href="<?= base_url('laporan_perperiode') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'laporan_perperiode') echo 'active' ?>">Laporan Data</a>
            </li>
        </ul> -->
    </section>
        ...
        <div class="container-fluid">
            <!-- <nav class="navbar sticky-top navbar-light bg-light">
                <form class="form-inline">
                    ...
                    <a class="btn btn-danger " href="<?php echo base_url('mahasiswa/print') ?>"><i class="fa fa-print"> </i> Print To PDF</a>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card card-secondary">
                        <div class="card-header" style="background-color: #2C3531;">
                            <h3 class="card-title">GEDUNG JURUSAN ILMU KOMPUTER</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fas fa-minus"></i>
                                </button>
